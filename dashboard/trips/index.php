      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          ...
          if ($result->num_rows > 0) {
           ...
           echo "<a href=\"newtrip/\" class=\"btn btn-sm btn-outline-success\"><span class=\"fas fa-map-marked-alt\"></span> Nuevo Viaje</a>&nbsp;\n";
           ...
           while($row = $result->fetch_assoc()) {
            ...
            if ($row["activo"]=='0') {
              ...
              echo " <div class=\"col-md-4 col-sm-6 portfolio-item border-right\">\n"; 
              echo "                  <a class=\"portfolio-link\" data-toggle=\"modal\" href=\"#portfolioModal1\">\n"; 
              echo "                    <div class=\"portfolio-hover\">\n"; 
              echo "                      <div class=\"portfolio-hover-content\">\n"; 
              ...
              if ($result2->num_rows >= 1) {
                ...
                while($row2 = $result2->fetch_assoc()) {
                  ...
                  echo "  <input type=\"hidden\"  name=\"viaje\" value=\"".$row["id_viaje"]."\">\n";  
                  
                  echo "<button type=\"submit\" class=\"btn btn-primary\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Tripulantes\">Entrar <span class=\"fas fa-arrow-right\"></span></button>\n"; 
                  echo "</form>\n"; 
                  echo "</div>\n"; 
                  echo "        <div class=\"col-sm-4\">"; 
                  echo "<form action=\"change_package/\" id=\"my_form\" method=\"post\">\n";
                  echo "  <input type=\"hidden\"  name=\"cambio\" value=\"\">\n";  
                  echo "  <input type=\"hidden\"  name=\"reserva\" value=\"\">\n"; 
                  //echo "<button type=\"submit\" class=\"btn btn-warning btn-sm\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Editar\"><span class=\"fas fa-edit\"></span></button>\n"; 
                  echo "</form>\n"; 
                  echo "</div>\n"; 
                  echo "        <div class=\"col-sm-4\">"; 

                  echo "<button type=\"submit\" class=\"btn btn-warning btn-sm\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Compartir\"><span class=\"fas fa-share-square\"></span></button>\n"; 
