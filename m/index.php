...
<html>
  ...
  <!-- Facebook and Twitter integration -->
	...
	<script src="https://kit.fontawesome.com/aea96dcbd9.js"></script>
	...
	<![endif]-->
	<style>
@import url('https://fonts.googleapis.com/css?family=DM+Sans|Nunito|Open+Sans+Condensed:300|Titillium+Web&display=swap');
</style>
		...
		<nav class="colorlib-nav" role="navigation">
			<div class="top-menu">
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-2">
							<div id="colorlib-logo"><a href="index.html"><img src="img/logo3.png" class="img-responsive" style="width:40%"></img></a></div>
						</div>
						<div class="col-xs-10 text-right menu-1">
							<ul>
								<!--<li class="active"><a href="tuviaje/">Publica tu viaje</a></li>-->
								<li class="has-dropdown">
									<a href="sign-in/"><i class="fas fa-user-astronaut fa-lg"></i></a>
									<ul class="dropdown">
										<li><a href="sign-in/">Iniciar Sesion</a></li>
										<li><a href="sign-in/signup.php">Registrarse</a></li>
									</ul>
								<li><a href="tuviaje/">Publica un viaje</a></li>

								</li>
								<!--<li><a href="hotels.html">Hotels</a></li>
								<li><a href="services.html">Services</a></li>
								<li><a href="blog.html">Blog</a></li>
								<li><a href="tuviaje/">Publica tu viaje</a></li>
			...
			<div class="flexslider">
				<ul class="slides">
			   	<!--<li style="background-image: url(images/img_bg_1.jpg);">
					...
					<?php
					$sql = "SELECT titulo, origen, destino, general_descripcion,id_viaje,main_image FROM viajes";
					...
					if ($result->num_rows > 0) {
					    ...
					    while($row = $result->fetch_assoc()) {
								...
								echo "<li style=\"background-image: url(".$row["main_image"].");\">\n";
echo "			   		<div class=\"overlay\"></div>\n";
echo "			   		<div class=\"container-fluid\">\n";
echo "			   			<div class=\"row\">\n";
echo "				   			<div class=\"col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text\">\n";
echo "				   				<div class=\"slider-text-inner text-center\">\n";
echo "				   					<h2>Nombre de Host</h2>\n";
				...
				<div class="row no-gutters">
					...
					<div class="col-md-3 animate-box text-center">
						<div class="services">
							...
							<h3>We accept the most popular prices</h3>
							<p>Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean. A small river named Duden flows by their place and supplies</p>
						</div>
					</div>
					<div class="col-md-3 animate-box text-center">
...
echo "					<div class=\"tour-img\" style=\"background-image: url(images/tour-2.jpg);\">\n";
echo "					</div>\n";
echo "					<span class=\"desc\">\n";
echo "						<p class=\"star\"><span><i class=\"icon-star-full\"></i><i class=\"icon-star-full\"></i><i class=\"icon-star-full\"></i><i class=\"icon-star-full\"></i><i class=\"icon-star-full\"></i></span> 545 Reviews</p>\n";
echo "						<h2>".$row["titulo"]."</h2>\n";
echo "						<span class=\"city\">Nombre de Host</span>\n";
echo "						<span class=\"price\">Desde: $450</span>\n";
echo "					</span>\n";
echo "				</a>\n";
						...
						<div class="f-tour">
							<div class="row row-pb-md">
								<div class="col-md-6">
									<div class="row">
										<div class="col-md-6 animate-box">
											<a  href="#" class="f-tour-img" style="background-image: url(images/tour-1.jpg);">
												<div class="desc">
													<h3>Rome - 5 Days</h3>
										...
										<div class="col-md-6 animate-box">
											<a  href="#" class="f-tour-img" style="background-image: url(images/tour-2.jpg);">
												<div class="desc">
													<h3>Rome - 5 Days</h3>
													<p class="price"><span>$120</span> <small>/ person</small></p>
												</div>
										...
										<div class="col-md-6 animate-box">
											<a  href="#" class="f-tour-img" style="background-image: url(images/tour-3.jpg);">
												<div class="desc">
													<h3>Rome - 5 Days</h3>
													<p class="price"><span>$120</span> <small>/ person</small></p>
												</div>
										...
										<div class="col-md-6 animate-box">
											<a  href="#" class="f-tour-img" style="background-image: url(images/tour-4.jpg);">
												<div class="desc">
													<h3>Rome - 5 Days</h3>
													<p class="price"><span>$120</span> <small>/ person</small></p>
												</div>
						...
						<div class="f-tour">
							<div class="row">
								<div class="col-md-6 col-md-push-6">
									<div class="row">
										<div class="col-md-6 animate-box">
											<a  href="#" class="f-tour-img" style="background-image: url(images/tour-5.jpg);">
												<div class="desc">
													<h3>Rome - 5 Days</h3>
													<p class="price"><span>$120</span> <small>/ person</small></p>
												</div>
										...
										<div class="col-md-6 animate-box">
											<a  href="#" class="f-tour-img" style="background-image: url(images/tour-6.jpg);">
												<div class="desc">
													<h3>Rome - 5 Days</h3>
													<p class="price"><span>$120</span> <small>/ person</small></p>
												</div>
										...
										<div class="col-md-6 animate-box">
											<a  href="#" class="f-tour-img" style="background-image: url(images/tour-7.jpg);">
												<div class="desc">
													<h3>Rome - 5 Days</h3>
													<p class="price"><span>$120</span> <small>/ person</small></p>
												</div>
										...
										<div class="col-md-6 animate-box">
											<a  href="#" class="f-tour-img" style="background-image: url(images/tour-8.jpg);">
												<div class="desc">
													<h3>Rome - 5 Days</h3>
													<p class="price"><span>$120</span> <small>/ person</small></p>
												</div>
		...
		<div id="colorlib-subscribe" style="background-image: url(images/img_bg_2.jpg);" data-stellar-background-ratio="0.5">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center colorlib-heading animate-box">
						<h2>Are you looking for a customized adventure?</h2>
						<p>Send us a mail and an expert will be in contact with you.</p>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12 text-center">
						<p>
							Powered by: <a href="https://agustirri.com/" target="_blank">Agustirri</a>
						</p>
					</div>
				</div>
			</div>
